...
public class Task4 {
    ...
    FileSplit inputSplit = new FileSplit(new File("task3_train_balanced.csv"));
    ...
    public void setNetwork() {
        MultiLayerConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .list(new DenseLayer.Builder().nOut(25).build(),
...
// Softmax at the output layer
    ...
    public void training() throws IOException {
        ...
        File modelSave = new File("task3_train-model-balanced.bin");
